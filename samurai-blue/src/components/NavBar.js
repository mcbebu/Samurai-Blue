        ...
        <div className="nav-container flex flex-col w-[250px] h-full tracking-wide gap-5 py-9 px-8 relative font-semibold">
            ...
            <div
                className={`nav-button ${
                    location.pathname.includes("/dashboard") ? "border-l-2" : ""
                }`}
            >
            ...
            <div
                className={`nav-button ${
                    location.pathname.includes("/orders") ? "border-l-2" : ""
                }`}
            >
            ...
            <div
                className={`nav-button ${
                    location.pathname.includes("/products") ? "border-l-2" : ""
                }`}
            >
            ...
            <div className="bottom-icons absolute bottom-8 left-5">
                ...
                <div
                    className={`nav-button ${
                        location.pathname.includes("/login") ? "border-l-2" : ""
                    }`}
                >
                    <ArrowLeftOnRectangleIcon className="w-[24px] h-[24px]"></ArrowLeftOnRectangleIcon>
                    <button onClick={ctx.logoutHandler}>
