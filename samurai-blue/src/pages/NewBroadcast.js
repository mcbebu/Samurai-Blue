...
async function checkAPI(message) {
    try {
        const lmao = await axios.post("http://159.138.108.231:8080/message", {
            message: message,
        });
...
const PAGE_TOKEN =
    "EAAHycBwKj80BAJt6lKp38FxwstGHh1eIIhkx3UJyAbDkuD9oHY92mDPaZCWLZCLCbE08nJumpLobsttvFtoo3w1vBBZAlFefc03W2MtPOXNBcepXTj8kL06BJYRPlX4PWRM5l4RDgR0rmWAq9yBra3AKUg5ydeqAN3DG0QA02S7HNlZC8X8CfdlEpxTCxxX2aH9tqLAwxoaWUZBCzVSw8DGUnKLKcRxQZD";
...
const source = new EventSource(
    "https://streaming-graph.facebook.com/115037204849377/live_comments?access_token=" +
        PAGE_TOKEN +
...
source.onmessage = async function (event) {
    ...
    const checkAPIreturn = await checkAPI(data.message);
    if (checkAPIreturn[0]) {
        console.log("===============");
        console.log("correct");
        await createOrder(checkAPIreturn);
    }
};
